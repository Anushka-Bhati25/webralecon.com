...
<div class="header4_img">
    <div class="overlay">
        <div class="header_tittle">
            <p class="header_tittle1" style="font-weight: bold;" >New Projects</p>
        ...
        <div class="wow fadeInUp" data-wow-delay="250ms" data-wow-duration="1.5s" style="visibility: visible; animation-delay: 250ms; animation-name: fadeInUp;">
            <div id="flat-gallery" class="cbp flat-gallery">
                ...
                <div class="cbp-item graphic finance">
                    <div class="overlay center-block whitecolor">
                        <figure class="snip1577">
                            <a href="img/project/portfolio1.jpg"  data-fancybox="gallery1"></a><img src="img/project/thumbnail1.jpg" alt="">
                            <figcaption>
                ...
                <div class="cbp-item graphic business">
                    <div class="overlay center-block whitecolor">
                        <figure class="snip1577">
                            <a href="img/project/portfolio11.jpg"  data-fancybox="gallery1"></a><img src="img/project/thumbnail11.jpg" alt="">
                            <figcaption>
                                <p class="icon-show"><i class="fas fa-search hover_search"></i></p>
                                <p class="hover_text">Our Project</p>
                            </figcaption>
                ...
                <div class="cbp-item graphic web">
                    <div class="overlay center-block whitecolor">
                        <figure class="snip1577">
                            <a href="img/project/portfolio3.jpg"  data-fancybox="gallery1"></a><img src="img/project/thumbnail3.jpg" alt="">
                            <figcaption>
                                <p class="icon-show"><i class="fas fa-search hover_search"></i></p>
                                <p class="hover_text">Our Project</p>
                            </figcaption>
                ...
                <div class="cbp-item graphic business">
                    <div class="overlay center-block whitecolor">
                        <figure class="snip1577">
                            <a href="img/project/portfolio4.jpg"  data-fancybox="gallery1"></a><img src="img/project/thumbnail4.jpg" alt="">
                            <figcaption>
                                <p class="icon-show"><i class="fas fa-search hover_search"></i></p>
                                <p class="hover_text">Our Project</p>
                            </figcaption>
                ...
                <div class="cbp-item graphic finance">
                    <div class="overlay center-block whitecolor">
                        <figure class="snip1577">
                            <a href="img/project/portfolio5.jpg"  data-fancybox="gallery1"></a><img src="img/project/thumbnail5.jpg" alt="">
                            <figcaption>
                                <p class="icon-show"><i class="fas fa-search hover_search"></i></p>
                                <p class="hover_text">Our Project</p>
                            </figcaption>
                ...
                <div class="cbp-item graphic web">
                    <div class="overlay center-block whitecolor">
                        <figure class="snip1577">
                            <a href="img/project/portfolio6.jpg"  data-fancybox="gallery1"></a><img src="img/project/thumbnail6.jpg" alt="">
                            <figcaption>
                                <p class="icon-show"><i class="fas fa-search hover_search"></i></p>
                                <p class="hover_text">Our Project</p>
                            </figcaption>
                ...
                <div class="cbp-item graphic finance">
                    <div class="overlay center-block whitecolor">
                        <figure class="snip1577">
                            <a href="img/project/portfolio7.jpg"  data-fancybox="gallery1"></a><img src="img/project/thumbnail7.jpg" alt="">
                            <figcaption>
                                <p class="icon-show"><i class="fas fa-search hover_search"></i></p>
                                <p class="hover_text">Our Project</p>
                            </figcaption>
                ...
                <div class="cbp-item graphic web">
                    <div class="overlay center-block whitecolor">
                        <figure class="snip1577">
                            <a href="img/project/portfolio8.jpg"  data-fancybox="gallery1"></a><img src="img/project/thumbnail8.jpg" alt="">
                            <figcaption>
                                <p class="icon-show"><i class="fas fa-search hover_search"></i></p>
                                <p class="hover_text">Our Project</p>
                            </figcaption>
                ...
                <div class="cbp-item graphic business">
                    <div class="overlay center-block whitecolor">
                        <figure class="snip1577">
                            <a href="img/project/portfolio9.jpg"  data-fancybox="gallery1"></a><img src="img/project/thumbnail9.jpg" alt="">
                            <figcaption>
                                <p class="icon-show"><i class="fas fa-search hover_search"></i></p>
                                <p class="hover_text">Our Project</p>
                            </figcaption>
                ...
                <div class="cbp-item graphic marketing">
                    <div class="overlay center-block whitecolor">
                        <figure class="snip1577">
                            <a href="img/project/portfolio10.jpg"  data-fancybox="gallery1"></a><img src="img/project/thumbnail10.jpg" alt="">
                            <figcaption>
                                <p class="icon-show"><i class="fas fa-search hover_search"></i></p>
                                <p class="hover_text">Our Project</p>
                            </figcaption>
                ...
                <div class="cbp-item graphic marketing">
                    <div class="overlay center-block whitecolor">
                        <figure class="snip1577">
                            <a href="img/project/portfolio2.jpg"  data-fancybox="gallery1"></a><img src="img/project/thumbnail2.jpg" alt="">
                            <figcaption>
                                <p class="icon-show"><i class="fas fa-search hover_search"></i></p>
                                <p class="hover_text">Our Project</p>
                            </figcaption>
                ...
                <div class="cbp-item graphic web">
                    <div class="overlay center-block whitecolor">
                        <figure class="snip1577">
                            <a href="img/project/portfolio12.jpg"  data-fancybox="gallery1"></a><img src="img/project/thumbnail12.jpg" alt="">
                            <figcaption>
                                <p class="icon-show"><i class="fas fa-search hover_search"></i></p>
                                <p class="hover_text">Our Project</p>
                            </figcaption>
        ...
        <div class="row">
            <div class="col-12 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1.3s" style="visibility: visible; animation-delay: 700ms; animation-name: fadeInUp;">
                <div class="contact_text">
                    ...
                    <a href="contact-us.html" class="btn btn-large btn-primary margin_button">Start Now</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="mapouter">
                <div class="gmap_canvas">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1754.607638359868!2d77.04141774901699!3d28.412760378337627!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d23a2408015fb%3A0x260765764c978645!2sWebralecon%20India%20(OPC)%20Pvt.%20Ltd.!5e0!3m2!1sen!2sin!4v1705395432952!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </div>
